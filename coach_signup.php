...
if ( isset($_POST["email"]) ) {
    ...
    if ($fname=='' || $lname=='' || $email=='' || $password=='' ) {
      ...
      if ($result->num_rows > 0) {
          ...
          header("Location: welcomeCoach.php");
          exit;
      }
    }
}
...
<form action="signup.php" method="POST" onsubmit="return checkPasswords()">
    Choose your interested sports to coach: <select name="player_sport">
    <?php
		$sport_available = "Select sport_type from Sport"
		$sport_available_result = db_query($sql)
		echo '<option value="">'.$sport_available
	?>
                </select>
    <br><br>
